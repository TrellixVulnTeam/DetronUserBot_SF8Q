...
@ULTRONBOT.on(admin_cmd(pattern="sin ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="cos ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="tan ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="sec ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="cot ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="square ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@ULTRONBOT.on(admin_cmd(pattern="cube ?(.*)"))
@ULTRONBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
