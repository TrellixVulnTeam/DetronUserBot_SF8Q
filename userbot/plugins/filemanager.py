...
async def _(event):
    ...
    OUTPUT = f"**Files in [DETRONBOT](t.me/LEGEND_Userbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your DETRONBOT server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of DETRONBOT repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your DETRONBOT server'
).add_command(
