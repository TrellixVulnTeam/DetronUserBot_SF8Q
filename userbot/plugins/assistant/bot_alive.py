...
pm_caption += "➥ **𝓛𝓲𝓬𝓮𝓷𝓼𝓮** : [GNU General Public License v3.0](github.com/ULTRON-OS/LEGENBOT/blob/master/LICENSE)\n"
pm_caption += "➥ 𝓒𝓸𝓹𝔂𝓻𝓲𝓼𝓱𝓽 : By [lҽցҽղժճօԵ](https://t.me/Legend_Userbot)\n"
pm_caption += "[Assistant By ℓεɠεn∂](https://t.me/Its_M1CKEY0P)"
