...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await edit_or_reply(event, "`Testing DETRONBOT`")
        ...
        await asyncio.sleep(2)
        await edit_or_reply(event, "**SAVING OUTPUT TO DETRONBOT LOCAL DATABASE**")
        await asyncio.sleep(3.5)
        await edit_or_reply(event, 
            "Your [DETRONBOT](https:/t.me/LEGEND_Userbot) is working Fine...\n       Join @LEGEND_Support For Any Help......"
        )
